 ...
 * @author xhl <supper@9126.org> <http://www.9126.org/>
 ...
 ======================================================== 使用说明 ================================================================
 1、使用该插件时需要调用该目录下的photo.html页面资源,并且需要带上两个参数；以下使用layer.js弹出调用图片库方式例子如下：
         layer.open({
                type: 2,
                title: "图片库",
                shadeClose: true,
...
$.fn.extend({
    jPicture: function (options) {
        ...
        var settings = {
            ...
            url: "http://mallapi.devpdmall.com",//伙伴商城 mallAPI 根目录URI
        ...
        self.selectBind = function (option) {
            ...
            $.each(obj, function (item, dom) {
                $(dom).find(".image-box").click(function () {
                    ...
                    var imageObj = { thumbPicUri: thumbPicUri, thumbPicUrl: thumbPicUrl, smallPicUri: smallPicUri, smallPicUrl: smallPicUrl, bigPicUri: bigPicUri, bigPicUrl: bigPicUrl, ID: dataId }
                    ...
                    if (option.width > -1 || option.height > -1) {
                        if (option.width == -1 || option.height == -1) {
                            ...
                            if (option.width == 0) {
                                ...
                                layer.msg("请选择大小为" + width + "x" + height + "的图片");
                                return;
                            }
                        }
                    }
